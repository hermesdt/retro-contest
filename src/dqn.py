...
class DQN():
    ...
    def build_model(self, initializer=None):
        ...
        x = tf.layers.Dense(60, kernel_initializer=initializer, activation=tf.keras.activations.relu)(x)
        #x = tf.keras.layers.LeakyReLU()(x)
        x = tf.layers.Dense(60, kernel_initializer=initializer, activation=tf.keras.activations.relu)(x)
        #x = tf.keras.layers.LeakyReLU()(x)
        x = tf.layers.Dense(30, kernel_initializer=initializer, activation=tf.keras.activations.relu)(x)
        #x = tf.keras.layers.LeakyReLU()(x)
        x = tf.layers.Dense(30, kernel_initializer=initializer, activation=tf.keras.activations.relu)(x)
        #x = tf.keras.layers.LeakyReLU()(x)
        x = tf.layers.Dense(30, kernel_initializer=initializer, activation=tf.keras.activations.relu)(x)
